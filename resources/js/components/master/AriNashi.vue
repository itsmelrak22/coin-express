    ...
    <div>
        ...
        <!-- mainTable Start -->
            <v-simple-table class="mainTable" fixed-header height="75vh">
                ...
                <tbody>
                    <tr v-for="(ariNashi, i) in ARI_NASHI" :key="i">
                         <td v-show="editMode">
                            <v-checkbox v-model="ariNashi.selected" dense></v-checkbox>
                        </td>
                        <td v-show="editMode"> 
                            <v-btn
                                fab
                                x-small
                                @click="toggleUpdateDialog(ariNashi)"
                            >
                                <v-icon >mdi-pencil</v-icon> 
                            </v-btn>
                        </td>
                        <td> {{ ariNashi.ari_nashi_name }} </td>
                        <td v-show="viewMode"> {{ formatDate(ariNashi.created_at) }} </td>
                        <td v-show="viewMode"> {{ formatDate(ariNashi.updated_at) }} </td>
                        <td v-show="viewMode"> {{ ariNashi.created_by }} </td>
                        <td v-show="viewMode"> {{ ariNashi.updated_by }} </td>
                    </tr>
                </tbody>
            </v-simple-table>
        <!-- mainTable End -->
                            ...
                            <v-row>
                                ...
                                <v-col cols="12">
                                    <v-text-field 
                                        outlined 
                                        dense 
                                        label="Ari/Nashi Value"
                                        name="ari_nashi_value" 
                                        class="required"
                                        :rules="rules.required"
                                    > </v-text-field>
                                </v-col>
                    ...
                    <v-card-title> <span class="overline">Edit Sash Type</span> </v-card-title>
                        <v-card-text>
                            <v-row>
                               <v-col cols="12">
                                    <v-text-field 
                                        v-model="tempData.ari_nashi_name"
                                        outlined 
                                        dense 
                                        label="Ari/Nashi Name"
                                        name="ari_nashi_name" 
                               ...
                               <v-col cols="12">
                                    <v-text-field 
                                        v-model="tempData.ari_nashi_value"
                                        outlined 
                                        dense 
                                        label="Ari/Nashi Value"
                                        name="ari_nashi_value" 
    ...
    export default {
        ...
        computed : {
            ...
            selectedData(){
                ...
                return this.ARI_NASHI.filter(res => res.selected).map(res => res.id); 
            }
        },
