    ...
    <div>
        ...
        <!-- mainTable Start -->
            <v-simple-table class="mainTable" fixed-header height="75vh">
                ...
                <tbody>
                    <tr v-for="(ITEM, i) in JIKU_STAIRS" :key="i">
                        <td v-show="editMode">
                        ...
                        <td> {{ ITEM.jiku_stair_name }} </td>
                        <td v-show="viewMode"> {{ ITEM.jiku_stair_value }} </td>
        ...
        <v-dialog v-model="dialogStore" max-width="300" persistent>
            <v-form id="Store" ref="Store" @submit.prevent="Store">
                <v-card>
                    <v-card-title> <span class="overline">Create Jiku Stair</span> </v-card-title>
                        <v-card-text>
                            <v-row>
                                <v-col cols="12">
                                    <v-text-field 
                                        outlined 
                                        dense 
                                        label="Jiku Stair Name"
                                        name="jiku_stair_name" 
                                        class="required"
                                ...
                                <v-col cols="12">
                                    <v-text-field 
                                        outlined 
                                        dense 
                                        label="Jiku Stair Value"
                                        name="jiku_stair_value" 
                                        class="required"
                                        :rules="rules.required"
                                    > </v-text-field>
                                </v-col>
                    ...
                    <v-card-title> <span class="overline">Edit House Type Category</span> </v-card-title>
                        <v-card-text>
                            <v-row>
                                <v-col cols="12">
                                    <v-text-field 
                                        v-model="tempData.jiku_stair_name"
                                        outlined 
                                        dense 
                                        label="Jiku Stair Name"
                                        name="jiku_stair_name" 
                                ...
                                <v-col cols="12">
                                    <v-text-field 
                                        v-model="tempData.jiku_stair_value"
                                        outlined 
                                        dense 
                                        label="Jiku Stair Value"
                                        name="jiku_stair_value" 
        ...
        <app-footer :items="JIKU_STAIRS.length"></app-footer>
    </div>
</template>
<script>
    ...
    export default {
        ...
        computed : {
            ...
            selectedData(){
                ...
                return this.JIKU_STAIRS.filter(res => res.selected).map(res => res.id); 
            }
        },
